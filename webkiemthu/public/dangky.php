        ...
        <form id="registerForm" action="#" class="space-y-5" method="POST">
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <label
                class="cursor-pointer rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-[#0f1723] px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:border-primary transition-colors"
              >
                <input
                  ...
                  checked
                />
                <span class="align-middle">Ứng viên</span>
              </label>
              <label
                class="cursor-pointer rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-[#0f1723] px-4 py-3 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:border-primary transition-colors"
              >
                <input
                  ...
                  value="employer"
                />
                <span class="align-middle">Nhà tuyển dụng</span>
              </label>
            </div>
          </div>
          <div>
